...
namespace Torneo
{
    public partial class Form1 : Form
    {
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            {
                objTorneo.PuntajePartidos[f, 0] = Interaction.InputBox("Introduce el nombre del equipo: " + (f + 1));

                for (int c = 1; c < objTorneo.PuntajePartidos.GetLength(1); c++)
                {
                    objTorneo.PuntajePartidos[f, c] = Interaction.InputBox("Introduce el puntaje del equipo recaba en el torneo: " + c);
                }
        ...
        {
            MessageBox.Show(objTorneo.EquipoGanador(), "Equipo Ganador", MessageBoxButtons.OKCancel, MessageBoxIcon.Asterisk, MessageBoxDefaultButton.Button1);
