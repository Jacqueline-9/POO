...
{
    public partial class FormMiPrimerArrayList : Form
    {
        ArrayList Personas = new ArrayList();

        public FormMiPrimerArrayList()
        {
            InitializeComponent();
        }
        ...
        {
            PersonaArrayList Persona1 = new PersonaArrayList();
            ...
            PersonaArrayList Persona2 = new PersonaArrayList();
            Persona2.ID = "2020";
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            PersonaArrayList miPersona = new PersonaArrayList();
        ...
        {
           foreach (PersonaArrayList Persona in Personas)
           {
