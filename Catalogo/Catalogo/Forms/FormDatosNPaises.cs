...
{
    public partial class FormDatosNPaises : Form
    {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            ...
            if(con == 1) { Paises = new DatosNPaises[cantidadPaises]; }
        ...
        private void tsbImprimir_Click(object sender, EventArgs e)
        {
            ...
            Imprimir Documento = new Imprimir();
            //Se llama al form
            Documento.Show();
