...
namespace Perritos
{
    public partial class FormPerritosAr : Form
    {
        PerritosAr[] objPerritos;
        ...
        private void btnEnter_Click(object sender, EventArgs e)
        {
            ...
            datosArchivos += "Perritos a registrar: " + cantidad + "\n";
            ...
            if (con == 1)
            {
                objPerritos = new PerritosAr[cantidad];
            }
        }
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if (con < cantidad)
            {
                ...
                datosArchivos += "\n" + "Nombre: " + objPerritos[i].Nombre + "\n";
                datosArchivos += "Edad: " + objPerritos[i].Edad + "\n";

                objPerritos[i].Peso = double.Parse(txtPeso.Text);
                datosArchivos += "Peso: " + objPerritos[i].Peso + "\n";

                objPerritos[i].Sexo = cmbSexo.Text;
                datosArchivos += "Sexo: " + objPerritos[i].Sexo + "\n";

                objPerritos[i].Color = new string[2];

                objPerritos[i].Color[0] = txtColor1.Text;
                datosArchivos += "Color 1: " + objPerritos[i].Color[0] + "\n";

                objPerritos[i].Color[1] = txtColor2.Text;
                datosArchivos += "Color 2: " + objPerritos[i].Color[1] + "\n";

                objPerritos[i].FechaIn = dtpFechaIn.Value;
                datosArchivos += "Fecha de ingreso: " + objPerritos[i].FechaIn + "\n";

                objPerritos[i].FechaEgre = dtpFechaTer.Value;
                datosArchivos += "Fecha de egreso: " + objPerritos[i].FechaEgre + "\n";
