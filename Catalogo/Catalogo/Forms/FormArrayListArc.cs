...
{
    public partial class FormArrayListArc : Form
    {
        ...
        private void tsbIngresar_Click(object sender, EventArgs e)
        {
            ...
            PersonaArrayListArc miPersona = new PersonaArrayListArc();
        ...
        {
            foreach (PersonaArrayListArc Persona in Personas)
            {
